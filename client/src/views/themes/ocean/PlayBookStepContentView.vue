  ...
  <div class="h-screen w-screen py-10 ocean-bg-none flex items-center justify-center">
    ...
    <div class="max-w-4xl w-full max-h-full  overflow-y-auto ocean-exam-content ocean-scrollbar">
      ...
      <div v-else-if="content && stepInfo" class="max-w-4xl mx-auto p-4">
        <!-- 步驟標題 -->
        <div class="ocean-bg-color-second rounded-lg shadow-sm p-4 mb-6">
          <div class="flex items-center gap-3 mb-4">
            <div
              class="w-12 h-12 ocean-bg-color-primary text-white rounded-full flex items-center justify-center font-semibold text-lg">
              {{ stepInfo.stepNumber }}
            </div>
            <div class="flex-1">
        ...
        <!-- 導航按鈕 -->
        <div class="ocean-bg-color-second rounded-lg shadow-sm p-6">
          <!-- 閱讀時間顯示 -->
