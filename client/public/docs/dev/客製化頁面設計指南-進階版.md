...
本指南將幫助進階開發者創建複雜的客製化頁面，這些頁面可以整合到 PlayBook 學習流程中。客製化頁面允許你創建互動式的學習內容，包括遊戲、模擬器、互動式圖表等。
...
1. 創建一個新的資料夾，命名為你的頁面名稱（例如：`my-interactive-lesson`）
2. 準備以下基本檔案：
   - `index.html` - 主要頁面檔案
   - `config.json` - 配置檔案
...
可用檔案類型： ".html",".htm",".css",".js",".jpg",".jpeg",".png",".gif",".webp",".svg",".woff",".woff2",".ttf",".otf",".json",".txt",".md",".mp3",".wav",".ogg",".mp4",".webm","m4a"
  ...
  <body>
    <div class="quiz-container">
      ...
      <div class="result" id="result" style="display: none;">
        <h3>測驗完成！</h3>
        <p>你的分數：<span id="score">0</span>/100</p>
    ...
    questionEl.innerHTML = `
            ...
            <div class="options">
                ${question.options
                  .map(
                    (option, index) =>
                      `<button class="option" data-value="${index}">${String.fromCharCode(
                        65 + index
                      )}. ${option}</button>`
                  )
                  .join("")}
